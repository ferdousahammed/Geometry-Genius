...
card.addEventListener('click', (e)=>{
    const constVal = e.target.parentNode.parentNode.firstElementChild.innerText.toLowerCase();
    ...
    document.getElementById(constVal).innerHTML = `<div>${constVal[0].toUpperCase()+constVal.slice(1)}</div>
              ...
              >
                <div id='${constVal}Marea' onclick='toMeterSquare(${area})'>Covert to m<sup>2</sup></div>
              </button>`
})
}
